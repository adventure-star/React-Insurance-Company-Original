...
import { lockReport } from '../utils/data.js';
...
const ReportLockContainer = Styled.article`
...
export default function Report() {
    ...
    const handleClick = (e) => {
        ...
        if (isDateValid && isAddressValid && isImageValid ) {
            setLoading(true);
            lockReport(date, address, image, invoice).then(res => {
                setLoading(false);
                console.log(res)
                if (res.error) {
                    setErrorModal(true)
    ...
    return (
        <ReportLockContainer>
            ...
            <img className="wheel-icon" src="/assets/body/lock.jpg" />
            <div className="main-div">
                <h1>Denuncia el daño en la <span className='underlined-span'>cerradura</span></h1>
                ...
                <div className="flex-box">
                    <div className='flex-form2'>
                        <span>Foto de la cerradura</span>
                                <ImageButton onChange={image => setImage(image)}  >
                            <img className='report-category' src='/assets/body/lock1.jpg' alt='something' />
                        </ImageButton>
