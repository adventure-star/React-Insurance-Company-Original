...
import { validOption2, validName, validDni, validModel, validZipcode } from '../utils/FormValidation.js'
...
const CompletePolicyContainer = Styled.div`
    ...
    .policy-error-form-title{
        font-size: 26px;
        font-weight: 400;
    }
    .policy-error-form-title > span {
        font-weight: 400;
    }
        ...
        return (
            <CompletePolicyContainer>
                ...
                <div className="policy-error-forms-container">
                    <Accordion
                        className="policy-error-form-container"
                        expanded={this.state.userExpanded}
                    >
                        <AccordionSummary
                            expandIcon={<ExpandMoreIcon style={{ fontSize: '40px', color: `${Theme.primaryColor}` }} />}
                            aria-controls="panel4bh-content"
                            id="panel4bh-header"
                            onClick={() => this.handleChangeUser(this.state.userExpanded)}
                    ...
                    <Accordion
                        className="policy-error-form-container"
                        expanded={this.state.vehicleExpanded}
                    >
                        <AccordionSummary
                            expandIcon={<ExpandMoreIcon style={{ fontSize: '40px', color: `${Theme.primaryColor}` }} />}
                            aria-controls="panel4bh-content"
                            id="panel4bh-header"
                            onClick={() => this.handleChangeVehicle(this.state.vehicleExpanded)}
                            className="accordion-summary"
                        >
                            <div className="form-header">
                            ...
                            <form>
                                ...
                                {this.state.engine !== null && this.state.engine !== '' ?
                                    <div className="form-line">
                                        ...
                                        />
                                        <p className="text-field-error" ref={engineError => this.engineError = engineError}>Colocá los números de tu engine sin puntos</p>
                                    </div>
                                    :
                                    <div className="form-line">
                                    </div>
                                ...
                                {this.state.chassis !== null && this.state.chassis !== '' ?
                                    <div className="form-line">
                                        ...
                                        />
                                        <p className="text-field-error" ref={chassisError => this.chassisError = chassisError}>Colocá los números de tu chassis sin puntos</p>
                                    </div>
                                    :
                                    <div className="form-line">
                                    </div>
                    ...
                    {this.state.insurer === null && this.state.coverage === null && (this.state.fromDate === null || this.state.fromDate === '') && (this.state.toDate === null || this.state.toDate === '') && this.state.quote === null ?
                        ...
                        <Accordion
                            className="policy-error-form-container"
                            expanded={this.state.policyExpanded}
                        >
                            <AccordionSummary
                                expandIcon={<ExpandMoreIcon style={{ fontSize: '40px', color: `${Theme.primaryColor}` }} />}
                                aria-controls="panel4bh-content"
                                id="panel4bh-header"
                                onClick={() => this.handleChangePolicy(this.state.policyExpanded)}
                                className="accordion-summary"
                            >
                                <div className="form-header">
                            ...
                            <AccordionDetails>
                                <form>
                                    {this.state.insurer !== null && this.state.insurer !== '' ?
                                        <div>
                                            {this.state.insurerOptions !== null ?
                                                <div className="form-line">
                                                    <label htmlFor="insurer" className="form-label">Compañía aseguradora</label>
                                                    <Form.Control as="select"
                                                ...
                                                <div className="form-line">
                                                    <label htmlFor="insurer" className="form-label">Compañía aseguradora</label>
                                                    <input className="text-field" type="text" id="insurer" onChange={(e) => this.handleInsurer(e)} ref={insurer => this.insurer = insurer} placeholder="Completar" />
                                    ...
                                    {this.state.fromDate !== null && this.state.fromDate !== '' ?
                                        <div className="form-line">
