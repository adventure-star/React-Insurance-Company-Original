        ...
        return (
            <form className="form-container">
                ...
                <div className="form-line">
                    ...
                    <input className="text-field" type="text" id="name" onChange={(e) => this.handleName(e)} ref={name => this.name = name} value={this.state.name} value={this.state.name} />
                    <p className="text-field-error" ref={nameError => this.nameError = nameError}>Colocá correctamente tu nombre completo</p>
                </div>
                <div className="form-line">
                    <label htmlFor="email" className="form-label">Email</label>
                    <input className="text-field" type="email" id="email" onChange={(e) => this.handleEmail(e)} ref={email => this.email = email} value={this.state.email} value={this.state.email} />
                    <p className="text-field-error" ref={emailError => this.emailError = emailError}>Colocá tu email (Ej: juan.perez@gmail.com)</p>
                </div>
                ...
                <div className="form-line">
                    ...
                    <input className="text-field" type="text" pattern="\d*" id="zipcode" onChange={(e) => this.handleZipcode(e)} ref={zipcode => this.zipcode = zipcode} value={this.state.zipcode} />
