        ...
        return (
            <form className="form-container" id="form">
                ...
                <div className="form-line">
                    ...
                    <div className="file-field">
                        ...
                        <button type="button" className="upload-btn-green" onClick={() => this.fileInput.click()}>
                            <img src="/assets/icons/upload.svg" alt="subir imagen" className="icon-upload" />
                        </button>
                    </div>
                ...
                <div className="form-line-left">
                    <AmplitudeButton id="form-button" bg={"green"} text={"Siguiente"} size={"small"} active={true} action={(e) => this.handleClick(e)} />
                </div>
            </form>
        )
    }
