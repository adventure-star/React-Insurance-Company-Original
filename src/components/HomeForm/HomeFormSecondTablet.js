...
export default class HomeFormSecondTablet extends Component {
    constructor(props) {
        super(props)
        this.state = {
            type: true,
    ...
    ModelsByYear() {
        ...
        return getModelsByBrandYear(brandID, year, groupID)
            .then(res => {
                showMessage("los modelos disponibles son: ", res)
                this.setState({ ...this.state, modelsOptions: res, modelReady:true })
                return res
            })
            .catch(e => showMessage(e))
    ...
    render() {
        return (
            <form className="form-container-tablet">
