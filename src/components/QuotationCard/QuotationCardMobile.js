        ...
        <CardContainer>
            <div className="section-one">
                ...
                <div className="sum-insured-container">
                    <p className="sum-insured">Suma asegurada: <span>{`$ ${transformNumber(sumInsured)}`}</span></p>                </div>}
            </div>
            <div className="section-two">
                <div className="details-container">
                    {renderDetails(coverageId)}
                </div>
                    <AmplitudeButton className="button" text={"Contratar"} bg={"green"} margin={'0px 20%'} action={() => handleClick(quoteId)}/>
            </div>
        </CardContainer>
    )
}
